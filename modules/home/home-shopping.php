...
$featured_shopping = get_sub_field('featured_shopping');
$shopping_posts = get_sub_field('shopping_posts');
                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="news-head">
                        ...
                        <ul class="news-menu-list">
                            ...
                            <?php endforeach; ?>
                            <?php endif; ?>
                            <li class="view-all"><a href="<?= get_post_type_archive_link('shopping') ?>">View All<em
                                        class="lnr lnr-arrow-right"></em></a></li>
                        </ul>
                    </div>
                    <div class="news-wrap row row-25">
                        <div class="news-left col-lg-6">
                            <?php if ($featured_shopping && !empty($featured_shopping)) : 
                                $post = $featured_shopping[0]; 
                                setup_postdata($post);
                            ?>
                            <div class="news-item">
                                <div class="image">
                        ...
                        <div class="news-right col-lg-6">
                            <div class="news-list row">
                                <?php if ($shopping_posts) : ?>
                                <?php foreach ($shopping_posts as $post) : 
                                        setup_postdata($post);
                                    ?>
