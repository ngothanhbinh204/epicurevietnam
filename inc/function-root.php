...
function register_my_menu()
{
	$locations = array(
		...
		'footer_menu' => __('Footer Menu', 'canhcamtheme'),
...
add_action('acf/init', function () {
	if (function_exists('acf_add_options_page')) {
		...
		// Add Archive Banner options sub page
		acf_add_options_sub_page(array(
			'page_title' 	=> 'Archive Banner Settings',
			'menu_title'	=> 'Archive Banners',
			'menu_slug' 	=> 'archive-banner-settings',
			'parent_slug'	=> 'theme-settings',
		));
	}
});
...
function changeAttrImage($url)
{
	...
	$image_output = str_replace('src="', 'src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" data-src="', $image_output);
	return $image_output;
}
